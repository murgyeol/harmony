...
const routes = [
  ...
  ["/projects/house", "Residential spaces designed with an emphasis on structural integrity"],
...
for (const [pathname, expected] of routes) {
  test(`server-renders ${pathname}`, async () => {
    ...
    if (pathname === "/projects/house") {
      ...
      assert.match(html, /prioritizing precision, longevity, and cohesive aesthetics/);
      assert.match(html, /\/project-photos\/house\/h01\.png/);
